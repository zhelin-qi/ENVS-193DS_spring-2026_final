...
# show residuals uniformly distributed between 0 and 1
...
# for each of the three ant species using the selected interaction model
preds_600 <- ggpredict(
  model2,
...
ggplot(
  ...
  geom_smooth(
    method    = "lm",         # fit a linear model smoother
    se        = TRUE,         # display 95% CI shading
    color     = "#7B2D8B",    # dark purple line
    fill      = "#C77CFF",    # light purple CI ribbon
    alpha     = 0.25,
    linewidth = 1
  ) +
  # plot individual daily observations on top of the CI band
  geom_point(
    size  = 3,
    color = "#7B2D8B",
    alpha = 0.85
